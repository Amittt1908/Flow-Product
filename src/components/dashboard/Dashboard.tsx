    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <StatCard
          ...
          subtitle={t('dashboard.activeInventoryItems')}
        ...
        <StatCard
          ...
          subtitle={t('dashboard.inventoryWorth')}
        ...
        <StatCard
          ...
          subtitle={t('dashboard.productTypes')}
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700">
            <div className="p-6 border-b border-gray-200 dark:border-gray-700">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm text-gray-500 dark:text-gray-400">{t('dashboard.lastItems')}</span>
              </div>
            </div>
            <div className="p-6">
              {recentProducts.length > 0 ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500 dark:text-gray-400">{t('dashboard.noProducts')}</p>
                </div>
              )}
            </div>
          </div>
            ...
            <div className="p-6">
              {lowStockProducts.length > 0 ? (
                    ...
                    <div key={product.id} className="flex items-center justify-between p-4 bg-red-50 dark:bg-red-900/10 rounded-xl border border-red-200 dark:border-red-800/50">
                      ...
                      <div className="flex items-center space-x-2">
                        <span className={`px-3 py-1 text-xs font-bold rounded-full ${
                          ...
                          {product.quantity} {t('dashboard.leftInStock')}
                        </span>
                      </div>
                    </div>
                  ))}
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500 dark:text-gray-400 font-medium">{t('dashboard.allWellStocked')}</p>
                  <p className="text-sm text-gray-400 dark:text-gray-500 mt-1">{t('dashboard.greatJob')}</p>
                </div>
              )}
            </div>
          </div>
