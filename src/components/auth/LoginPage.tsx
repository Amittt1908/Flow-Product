          ...
          <div className="mt-8 p-6 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-2xl border border-blue-200/50 dark:border-blue-700/50">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex justify-between items-center p-3 bg-white/50 dark:bg-gray-800/50 rounded-xl">
                <div>
                  <span className="font-medium text-gray-700 dark:text-gray-300">{t('auth.manager')}</span>
                  <p className="text-xs text-gray-500 dark:text-gray-400">{t('auth.fullAccess')}</p>
                </div>
                <button
              ...
              <div className="flex justify-between items-center p-3 bg-white/50 dark:bg-gray-800/50 rounded-xl">
                <div>
                  <span className="font-medium text-gray-700 dark:text-gray-300">{t('auth.storeKeeper')}</span>
                  <p className="text-xs text-gray-500 dark:text-gray-400">{t('auth.limitedAccess')}</p>
                </div>
                <button
